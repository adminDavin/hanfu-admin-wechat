...
Component({
  ...
  methods: {
    ...
    onSeletedProduct:function(e) {
      ...
      wx.navigateTo({
        url: '/pages/product/group-detail?action=groupActivity&productId=' + dataset.id + '&stoneId=' + dataset.stoneId + '&activityId=' + dataset.activityId +'&priceArea='+ dataset.priceArea
      })
    }
  },
  lifetimes: {
